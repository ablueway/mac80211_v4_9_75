    ...
    if (!strcmp(argv[1], "set")){
        ...
        if(!strcmp(argv[2], "bbscale")){
            ...
            if  (argc == 4){
                ...
                if ((regval == 91) || (regval == 96) || (regval == 100) || (regval == 108) ||
                    (regval == 114) || (regval == 121) || (regval == 128) || (regval == 136) ||
                    (regval == 144) || (regval == 152) || (regval == 161) || (regval == 171) ||
                    (regval == 181)) {
        ...
        snprintf_res(cmd_data,"\n\t./cli rf set|get|phy_txgen|block|unblock|count\n");
        return;
    }
out:
